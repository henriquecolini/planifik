...
const translations = {
  ...
  setDefaultBalance:    { en: "Set as default for all months", "pt-BR": "Definir como padrão para todos os meses" },
  ...
  bothBalancesExplain:  { en: "This item has a specific balance for this month and a global default.", "pt-BR": "Este item tem um valor específico para este mês e um valor padrão global." },
